...
CREATE TABLE Horse (
	...
	CONSTRAINT PK_Microchip PRIMARY KEY (Microchip),
...
CREATE TABLE HorseVaccine (
	...
	--- This should be created based on the value of VaccineDate (if annual, then add 365 days)
	...
	CONSTRAINT FK1_HorseVaccine FOREIGN KEY (Microchip) REFERENCES Horse(Microchip),
